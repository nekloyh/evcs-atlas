 ...
 * lọt ngưỡng). Không câu nào nói vì sao. Đó đúng là thứ §3a cấm: **giao diện hứa một thứ
 * nó không có**, khiến người xem đọc "không có ô nào ngoài 2 km" thay vì "bộ này chưa đo
 * khoảng cách".
 *
