...
export function RoadPanel({ id, road, loading, onOpenAccess }: { id: string; road: RoadSeg | null; loading: boolean; onOpenAccess: () => void }) {
  return <div className="text-title">
    <div className="flex items-center justify-end border-b border-hairline px-2 py-1.5">
      <span className="font-mono text-note text-ink-muted">OSM way {id}</span>
    </div>
